        ...
        for call_metadata in call_metadata_list:
            ...
            try:
                ...
                if call_cached:
                    ...
                    start = datetime.strptime(js_get("executionEvents[?description == 'waiting for quota'] | [0].endTime", call_metadata), date_format)
                    end = datetime.strptime(js_get("executionEvents[?description == 'Worker released'] | [0].endTime", call_metadata), date_format)
